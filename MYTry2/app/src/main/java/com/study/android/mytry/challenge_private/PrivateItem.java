...
public class PrivateItem {
    ...
    public PrivateItem(int num, String title, String category, String type, String frequency, String start, String end, String fee, String detail, String first_image, String state, String pub, String exp, String alongday, String host) {
        this.num = num;
        this.title = title;
