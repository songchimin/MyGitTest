        ...
        protected void onPostExecute(String json) {
            ...
            try {
                ...
                for (int i = 0; i < ListArray.length(); i++) {
                    ...
                    publicItems[i] = new PublicItem(ListObject.getInt("challenge_num"), ListObject.getString("challenge_title"), ListObject.getString("challenge_type"), ListObject.getInt("challenge_like_count"), ListObject.getInt("challenge_like_exist"));
