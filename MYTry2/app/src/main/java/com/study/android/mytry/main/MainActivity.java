...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int MYPAGE_QNA_FINISH_ = 65542;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == MYPAGE_QNA_FINISH_) {
            Log.d("yejin", "Main 오니 안오니1");
            if (resultCode == RESULT_OK) {
                Log.d("lecture", "Main 들어오니");
                FragmentManager fm = getSupportFragmentManager();
                ...
                fragmentTransaction.setCustomAnimations(R.anim.pull_in_right, R.anim.push_out_left, R.anim.pull_in_left, R.anim.push_out_right);
                fragmentTransaction.replace(R.id.qna_main, new QnAMain()).addToBackStack(null).commitAllowingStateLoss();
            }
        } else if (requestCode == MYPAGE_MEMO_FINISH) {
            Log.d("yejin", "Main 오니 안오니1");
            if (resultCode == RESULT_OK) {
                Log.d("lecture", "Main 들어오니");
                FragmentManager fm = getSupportFragmentManager();
                ...
                fragmentTransaction.setCustomAnimations(R.anim.pull_in_right, R.anim.push_out_left, R.anim.pull_in_left, R.anim.push_out_right);
                fragmentTransaction.replace(R.id.mypage, new Fragment_Mypage()).addToBackStack(null).commitAllowingStateLoss();
            }
        }
