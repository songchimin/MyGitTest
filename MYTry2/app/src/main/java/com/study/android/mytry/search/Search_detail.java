...
public class Search_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(i_bookmake==0) {
            search_content_like_btn.setBackgroundResource(R.drawable.main_like_btn1);

        }
        else{
            search_content_like_btn.setBackgroundResource(R.drawable.main_like_btn2);
        }
    ...
    public void refuresh(){
        ...
        transaction.replace(R.id.fragment_creation, new Challenge_Content()).addToBackStack(null).commit();
    }
