...
public class searchmain_singerAdapter extends BaseAdapter {
    ...
    public View getView(final int position,final View convertView, ViewGroup parent){
        ...
        if(item.getBookmaker_exist()==0) {
            bookmaker.setImageResource(R.drawable.main_like_btn1);
        }
        else{
            bookmaker.setImageResource(R.drawable.main_like_btn2);
        }
        ...
        bookmaker.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                }else if(item.getBookmaker_exist()==1){
