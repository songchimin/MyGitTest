...
public class InsertController {
   ...
   public void feed_insert(HttpServletRequest request, 
      ...
      if(information.substring(0, 3).equals("map")) {
    	  System.out.println("feed_infooooo : "+information);
    	  
    	  String location = information.substring(4);
    	  ...
    	  for(int i=0; i<arr.length; i++) {
    		  System.out.println("arrrrrrrrrrrrr   "+arr[i]);
    		  
    		  idx = arr[i].indexOf(",");
    		  latitude = arr[i].substring(0,idx);
    		  longitude = arr[i].substring(idx+1);
