...
public class MyPageController {
	...
	public void MyPageMemoInsert(Model model, 
		...
		//memo_date = date.format(memo_date);
	...
	public void MyPageAccount(Model model, 
			@RequestParam("id") String id, 
			@RequestParam("bank") String bank, 
			@RequestParam("account") String introduce,
			@RequestParam("holder") String holder) {
		
		dao.AccountModify(id, bank+","+ introduce+","+ holder);
	
	}
	
	@RequestMapping("/mypage_account_list")
	public String AccountList(Model model, 
			@RequestParam("id") String id) {
		
		System.out.println(id);
		model.addAttribute("accountList",dao.AccountList(id) );		

		return "/mypage/accountlist";
	}
