			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
				...
				<nav class="my-2 my-md-0 mr-md-3" style="text-align: right;">
					<br> <a class="p-2" href="/account_home"
						...
						style="color: red; font-weight: bold;">챌린지 관리</a> <a class="p-2"
				...
				<div class="my-4 w-100" width="1083" height="457"
					...
					<div class="row">
						...
						<table class="table" style="width: 20%; margin-top: 30px;">
							...
							<tr style="background-color: #FF5D5D">
								<th style="text-align: center; color: white;">챌린지 참여 총 금액</th>
							</tr>
							<tr>
							...
							<tr style="background-color: #FF5D5D">
								<th style="text-align: center; color: white;">챌린지 총 참여 횟수</th>
							</tr>
							<tr>
								<td><%=totalcount%></td>
							</tr>
							...
							<tr style="background-color: #FF5D5D">
								<th style="text-align: center; color: white;">챌린지 총 개설 횟수</th>
							</tr>
							<tr>
...
<!-- 						100% 성공자 수 : -->
<%-- 						<%=count%><br> 챌린지 참여 총 금액 : --%>
<%-- 						<%=totalfee%><br> 챌린지 총 참여 횟수 : --%>
<%-- 						<%=totalcount%><br> 챌린지 총 개설 횟수 : --%>
<%-- 						<%=totalchallenge%><br> --%>
