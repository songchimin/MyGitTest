...
<header><!-- bg-white #FFFED7-->
	<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 border-bottom shadow-sm" style="background-color: #000000;">
      <h5 class="my-0 mr-md-auto font-weight-normal"><a href="/home"><img alt="" src="/img/vvvvvvvvv.png"></a></h5>
      
      <nav class="my-2 my-md-0 mr-md-3">
     		
        	<a class="p-2" href="/account_home" style="color: #FFFFFF; font-weight: bold;">계정관리</a>
 			<a class="p-2" href="/register_challenge?page=1" style="color: #FFFFFF; font-weight: bold;">챌린지 관리</a>
 			<a class="p-2" href="/cash_mileage?page=1" style="color: #FFFFFF; font-weight: bold;">결제 관리</a>
 			<a class="p-2" href="/payment_" style="color: #FFFFFF; font-weight: bold;">신고 관리</a>
 			<a class="p-2" href="/waitQnA?page=1" style="color: #FFFFFF; font-weight: bold;">Q & A</a>
