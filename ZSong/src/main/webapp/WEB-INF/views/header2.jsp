...
<%-- 			<c:if test="${id!=null}"> --%>
	     		<a id="chat" href="#" ondblclick="SirenFunction('SirenDiv'); return false;" class="blind_view" style="position:fixed; z-index: 1242145; left: 92%; top: 87%; cursor:pointer; cursor:hand" onmousedown="startDrag(event, this)"><img alt="채팅" src="/img/chat.png"><span style="position:relative; z-index: 1242145; right: 20px; bottom: 20px; " id="unread" class="badge badge-danger"></span></a>
<%--      		</c:if> --%>
